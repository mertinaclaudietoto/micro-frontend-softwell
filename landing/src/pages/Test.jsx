  ...
  return (
    ...
    <div class="relative z-10 bg-white  w-full max-w-4xl  mx-auto p-6 md:p-10">
        ...
        <div class="flex items-center  justify-center mb-4">
            <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Sign up</h1>
        </div>
        <p class="text-sm text-gray-600 flex items-center justify-center">
            Already a Member? 
            <a href="#" class="text-orange-500 hover:text-orange-600 font-semibold">Sign In</a>
        </p>
       {/* etaps formulaire */}
        <div class="flex items-center justify-center mb-8 md:mb-12">
            <div class="flex items-center gap-4 md:gap-8">
                ...
                <div class="flex flex-col items-center gap-2">
                    <div class="step-active w-10 h-10 rounded-full flex items-center justify-center font-semibold text-lg">
                        1
                    </div>
                ...
                <div class="flex flex-col items-center gap-2">
                    <div class="step-inactive w-10 h-10 rounded-full flex items-center justify-center font-semibold text-lg">
                        2
                    </div>
