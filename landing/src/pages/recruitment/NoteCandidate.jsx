...
import CVCandidate from "../manager/sous/CVCandidate";
import { Sidebar } from "../../components";
export default function NoteCandidate({idrequest,idpost ,idstep,rang,email ,close}){
    ...
    const [showInfoCandidate,setShowInfoCandidate]=useState(false);
    const [parmInfo,setShowParam]=useState(null);
    useEffect(() => {
            loadData();
        }, [loadData]);
      return(
        <>
            {
                showInfoCandidate ?
                <>
                     <CVCandidate id={parmInfo.candidateId} idrequest={idrequest} idpost={idpost} rang={rang} idstep={idstep} email={email} close={setShowInfoCandidate} ></CVCandidate>
                </> : 
                <>
