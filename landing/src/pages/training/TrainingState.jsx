...
export default function TrainingState({value}){
    ...
    return(
        ...
        {showAddsession ? <CardAddSession  close={setShowAddsession} idvalidation={value.id} ></CardAddSession>
        :<>
         <div class="flex">
            <Sidebar/>
                        ...
                        <div className="flex-1 w-2/3 border-rigth ">
                            <div class="flex items-start gap-3 p-8">
                                    ...
                                    <div class="flex-1 min-w-0 w-100">
                                        <h4 class="font-bold text-gray-900 mb-1 text-start">{value.themeName}</h4>
                                                ...
                                                <tr index={index} className="hover:bg-gray-50">
                                                    <td class="px-6 py-4 text-sm text-gray-500">
                                                        {/* <img
                                                                ...
                                                                alt={value.login}
                                                            /> */}
                                                        <div class="text-sm font-medium text-gray-900">{value.matricule}</div>
                                                    </td>
                                                    <td class="px-6 py-4">
                                                        <div class="text-sm font-medium text-gray-900">{value.name}</div>
                                                    </td>
                                                    <td class="px-6 py-4">
                                                        <div class="text-sm font-medium text-gray-900">{value.firstName}</div>
                                                    </td>
                                                    <td class="px-6 py-4">
                                                        <div class="text-sm font-medium text-gray-900">
                                                            <span class={`inline-flex items-center px-2.5 py-0.5 rounded text-xs font-medium ${textbackground[index]} mb-1`}>{value.Email}</span>
                                                        </div>
                                                    </td>
                                                    {/* <td class="px-6 py-4">
