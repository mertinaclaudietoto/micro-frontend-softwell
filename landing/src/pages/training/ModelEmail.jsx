...
import UpdateModelEmail from "../../components/email/training/UpdateModelEmail";
...
export default function ModelEmail(){
    ...
    const modification =  async (value)=>{
        const  response = await getData(
            url_sendemail + `${nameE}/getById?id=${value.id}`
        );
        if(response.data!=null){
           
            setUpValue(response.data);
            setShowUpdate(true);
        }
    }
    ...
    useEffect(() => {
      ...
      return(
        <>
        {showUpdate  ? <UpdateModelEmail setData={setUpValue} close={setShowUpdate} value={upValue} /> : <></> }
                    ...
                    <div className=" max-w-7xl mx-auto bg-white p-10 ">
                        ...
                        <div class="p-4 mb-2 border-b border-gray-200 sticky top-0 z-50 pink ">
                            <div class="flex items-center justify-between">
                                <h2 class="text-xl font-semibold text-gray-800">Liste Model email
