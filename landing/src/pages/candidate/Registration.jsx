...
export default function Registration(){
    ...
    const handlerChangeTableInfocandidate = (name, value, index = null) => {
        setInfoCandidate((previous) => {
            const currentArray = previous[name] || [];
            if (index !== null) {
        ...
        console.log(infocandidate.hardskill)
        setHardSkill("");
    };
        ...
        case 1:
            return (
                    ...
                    <div>
                            ...
                            <div>
                                ...
                                <div class="flex gap-4">
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="gender" value="male" checked class="w-5 h-5 text-softbleu/100 focus:ring-orange-500"/>
                        ...
                        <div class=" border-t border-gray-200">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <button class="text-softbleu   font-bold text-sm flex items-center gap-1">
                ...
                <div class="flex justify-end mt-8">
                    <button class="btn_rectangle_action"
                    onClick={()=>nextOrPrecedent(index+1)}>
                        Continue
                    </button>
                </div>
                </div> 
            ...
            return (
                <div>
                    ...
                    <div class="flex justify-between mt-8">
                        <button class="px-8 py-3 bg-gray-500 hover:bg-gray-600 text-white rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition-all"  onClick={()=>nextOrPrecedent(index-1)}>
                            Retoure
                        </button>
                        <button class="px-8 py-3 bg-orange-500 hover:bg-orange-600 text-white rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition-all"  onClick={()=>nextOrPrecedent(index+1)}>
                            Save & Continue
                        </button>
                    </div>
                </div> 
                ...
                <div>
                    ...
                    <div class=" border-t border-gray-200">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <button class="text-or   font-bold text-sm flex items-center gap-1" onClick={()=>handlerChangeTableInfocandidate("hardskill",hardskill,null)}>
                                <i class="fas fa-plus"></i>
                                Ajouter
                            </button>
                        </div>
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-4'>
                            ...
                            <div class="flex flex-wrap gap-2">
                                {infocandidate.hardskill.map((value,index)=>(
                                    <button className="card-text-rounded-gray" onClick={()=>handlerChangeTableInfocandidate("hardskill",hardskill,index)}>
                                            {value.name}
                                    </button>
                                    ))
                                }
                    ...
                    <div class="border-t border-gray-200">
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-4'>
                            ...
                            <div>   
                                <div class="flex flex-wrap gap-2">
                                    {infocandidate.hardskill.map((value,index)=>(
                                        <button className="card-text-rounded-gray" onClick={()=>handlerChangeTableInfocandidate("softskill",softskill,index)}>
                                            {value.name}
                                        </button>
                                    ))
                                    }
        ...
        <div>
            <div class="grid grid-cols-1">
                <div class="">
                    ...
                    <label class="block text-sm font-medium text-gray-700 mb-2 py-2">Liste de vos  experiences</label>
                    {infocandidate.experience.map((value,index)=>(
                        <div index={index} class="mt-4 bg-gray-50 rounded-lg p-4 relative">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
