...
export default function Profile(){
    ...
    const getInfoCandidat = async ()=>{
        const value =  await getData(
            url_recrutement + `candidate/`+sessionStorage.getItem("userId")
        );
        if(value.data!=null){
            setData(value.data);
    ...
    return (
    <> 
        <div className="bg-white  overflow-hidden h-max px-10 pb-10">
            <Header></Header>
                ...
                <div>
                    ...
                    <div className='my-2'>
                        ...
                        <div className="relative">
                            <Select onChange={handlerLocalisation} placeholder={data.localisationName} options={listLocalisation}/>
