...
export default function Inscription(){
    ...
    <div class="relative z-10 bg-white  w-full max-w-4xl  mx-auto p-6 md:p-10">
        ...
        <p class="text-sm text-gray-600 flex items-center justify-center">
            ...
            <a href="#" class="text-or hover:text-orange-600 font-semibold">Connecte-toi</a>
        </p>
       {/* etaps formulaire */}
        <div class="flex items-center justify-center mb-5 ">
            <div class="flex items-center gap-4 md:gap-8">
                <div class="flex flex-col items-center gap-2">
                    <div class="step-active w-10 h-10 rounded-full flex items-center justify-center font-semibold text-sm">
                        1
                    </div>
                    {/* <p class="text-xs md:text-sm font-medium text-gray-700">Info Personnel</p> */}
                </div>
                
              
                <div class="w-16 md:w-24 h-0.5 bg-gray-300"></div>
          
                <div class="flex flex-col items-center gap-2">
                    <div class="step-inactive w-10 h-10 rounded-full flex items-center justify-center font-semibold text-sm">
                        2
                    </div>
                    {/* <p class="text-xs md:text-sm font-medium text-gray-500">Contact Details</p> */}
                </div>
                ...
                <div class="flex flex-col items-center gap-2">
                    ...
                    {/* <p class="text-xs md:text-sm font-medium text-gray-500">Verification</p> */}
                </div>
            </div>
        </div>
       {/* fin formulaire */}
