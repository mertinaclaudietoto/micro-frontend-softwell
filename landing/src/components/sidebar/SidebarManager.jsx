...
import { items,parametres,short } from "../../data/menumanager";
                    ...
                    <aside class="w-80 bg-white  flex flex-col border-r border-gray-200">
                        ...
                        <div class="flex-1 overflow-y-auto">
                            <div class="p-4">
                                ...
                                <div class="space-y-1">
                                    {items.map((value,index)=>(<SidebarLargButton link={value.link} index={index} icone={value.icone} item={value.item}  actif={value.actif}/>))}
                                </div>
                            </div>
                            {/* pub */}
                            <CardPub/>
