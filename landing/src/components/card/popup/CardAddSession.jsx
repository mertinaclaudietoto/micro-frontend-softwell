...
export default function CardAddSession({close,infoTraining}){
        ...
        <div class="background_transparent_popup"> 
            <div class="min-h-screen flex items-center justify-center p-4 ">
                ...
                <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 relative">
                    ...
                    <h3 className="font-medium">Ajouter session</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-2">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Heur debut matin </label>
                            <div class="relative">
                                <input 
                                    type="time" 
                                    class="input_singup"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Heur fin matin</label>
                            <div class="relative">
                                <input 
                                    type="time" 
                                    class="input_singup"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-2">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Heure debut soir</label>
                                <div class="relative">
                                    <input 
                                        type="time" 
                                        class="input_singup"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Heure debut fin</label>
                                <div class="relative">
                                    <input 
                                        type="time" 
                                        class="input_singup"
