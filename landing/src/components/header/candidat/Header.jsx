...
export default function Header () {
  const menus = ["Find Jobs", "Company Reviews", "Salary Guide"];
  return (
  <>
    <header class="py-4 border-b border-gray-200">
      <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-3 md:gap-4 md:pr-8">
              <button class="text-gray-600 hover:text-blue-600"><HiChatBubbleBottomCenterText></HiChatBubbleBottomCenterText></button>
              <button class="text-gray-600 hover:text-blue-600"><HiBell></HiBell></button>
              <button class="text-gray-600 hover:text-blue-600"><HiMiniUser></HiMiniUser></button>
              <span class="hidden md:inline text-sm text-gray-700">Employers/ Post Job</span>
          </div>
      </div>
            {/* mobile nav bar */}
